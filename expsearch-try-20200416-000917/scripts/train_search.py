...
parser.add_argument('--noarc',type=int,default=2,help='no arch optimization')
parser.add_argument('--sample',type=int,action='append',default=[],help='the propotion of channel sample')
parser.add_argument('--use_baidu',type=bool,default=True,help='whether to use the reduction cell of GDAS which designed by baidu')
...
def main():
    ...
    if len(args.sample) == args.stages:
        ...
        sample=[[4,8],[4,8,8]][args.stages-2]                     #通道32-64
